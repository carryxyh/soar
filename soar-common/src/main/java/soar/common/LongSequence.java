 ...
 * ---------------------------------------
 * For 32 bit JVM:
 * <t>  _mark   : 4 byte constant
 * <t>  _klass  : 4 byte pointer to class
 * For 64 bit JVM:
 * <t>  _mark   : 8 byte constant
 * <t>  _klass  : 8 byte pointer to class
...
public class LongSequence extends LongRhsPadding {
    ...
    private final FastThreadLocal<LocalSequence> localSequence = new FastThreadLocal<LocalSequence>() {
